...
import forms from "../../../images/icons/events/Icons-sitewide-events-01.svg"
      ...
      <SubmitStyled className="submitlink">
        <StandardWrapper className="submitlink__wrapper">
          ...
          <div className="submitlink__content">
            <p>
              Does your Airdrie Sport team have an upcoming event you would like
              to submit?
            </p>
          </div>
          <div className="submitlink__button">
            <NormalLink to="/local-sports-events/event-submission">
              Submit Event
            </NormalLink>
          </div>
        </StandardWrapper>
