...
@font-face {
  ...
  src:
    ...
    url('${lato.lato100WOFF2}') format("woff2"),
    url('${lato.lato100WOFF}') format("woff");
}
...
@font-face {
  ...
  src:
    ...
    url('${lato.lato100WOFF2ITC}') format("woff2"),
    url('${lato.lato100WOFFITC}') format("woff");
}
...
@font-face {
  ...
  src:
    local("lato ExtraBold"),
    local("lato-ExtraBold"),
    url('${lato.lato900WOFF2}') format("woff2"),
    url('${lato.lato900WOFF}') format("woff"); 
}
...
@font-face {
  ...
  src:
    local("lato ExtraBold"),
    local("lato-ExtraBold"),
    url('${lato.lato900WOFF2ITC}') format("woff2"),
    url('${lato.lato900WOFFITC}') format("woff"); 
}
