...
const Disclaimer = props => {
  return (
    <Layout location={props.location.pathname}>
      <SEO
        title="Disclaimer - Airdrie Sports"
      ...
      <DisclaimerStyled>
        ...
        <div>
          <p>
            ...
            express or implied. Airdrie Sports makes no representations or
            warranties related to this website or the information and materials
            provided on this website. Airdrie Sports does not warrant that this
            website will be available at any or all times, or that the
            ...
            as advice of any kind. Airdrie Sports makes no representations or
          ...
          <p>
            Airdrie Sports assumes no liability in relation to the contents of,
          ...
          <p>
            The materials on Airdrie Sports’s website are provided on an ‘as is’
            basis. Airdrie Sports’s makes no warranties, expressed or implied,
          ...
          <p>
            Further, Airdrie Sports does not warrant or make any representations
          ...
          <p>
            ...
            are not under the control of “Airdrie Sports”. We have no control
        ...
        <div>
          <p>
            Copyright © Airdrie Sports All Rights Reserved. All text, images,
            graphics, and other materials on this website are subject to the
            copyright and other intellectual property rights of Airdrie Sports,
            ...
            express written permission of Airdrie Sports
          </p>
        </div>
      </DisclaimerStyled>
    </Layout>
